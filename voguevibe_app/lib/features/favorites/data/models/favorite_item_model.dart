...
/// Proxy model that extends FavoriteItemEntity and delegates mutable fields
...
class FavoriteItemModel extends FavoriteItemEntity {
  ...
  FavoriteItemModel._(this._legacy)
      : super(
          id: _legacy.id,
          title: _legacy.title,
  ...
  factory FavoriteItemModel.fromLegacy(ProductModel legacy) =>
      FavoriteItemModel._(legacy);
